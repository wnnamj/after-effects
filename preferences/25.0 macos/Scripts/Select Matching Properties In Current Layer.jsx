...
(function() {
    ...
    // Function to select properties by match name within selected layers
    ...
    app.beginUndoGroup('Select Matching Properties in Selected Layers');

    // Iterate over selected layers and select matching properties
